...
module design_1
  ...
  wire axi_regs_latest_2_0_start;
  ...
  wire [11:0]bram_sum_0_addr;
  wire bram_sum_0_done;
  wire [31:0]bram_sum_0_sum;
  ...
  design_1_axi_bram_ctrl_0_bram_0 axi_bram_ctrl_0_bram
       (.addra({1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,axi_bram_ctrl_0_BRAM_PORTA_ADDR}),
        ...
        .web(xlconstant_2_dout[3:0]));
  design_1_axi_regs_latest_2_0_0 axi_regs_latest_2_0
       (.done(bram_sum_0_done),
        ...
        .start(axi_regs_latest_2_0_start),
        .sum(bram_sum_0_sum));
  ...
  design_1_bram_sum_0_0 bram_sum_0
       (.addr(bram_sum_0_addr),
        .clk(processing_system7_0_FCLK_CLK0),
        .data(axi_bram_ctrl_0_bram_doutb),
        .done(bram_sum_0_done),
